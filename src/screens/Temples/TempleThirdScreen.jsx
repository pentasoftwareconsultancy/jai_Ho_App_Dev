...
const TempleThirdScreen = ({ route, navigation }) => {
  ...
  const [isReading, setIsReading] = useState(false); // State to track if description is being read
  ...
  // Function to toggle reading the description
  const toggleReadDescription = () => {
    const description = `Shri Hanuman and Shani Temple is a place of spiritual significance, known for its divine atmosphere and
    ...
    if (isReading) {
      ...
      Speech.speak(description, { language: "hi-IN" }); // Use 'mr-IN' for Marathi
      setIsReading(true);
    }
  };
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.description}>
          Shri Hanuman and Shani Temple is a place of spiritual significance,
          known for its divine atmosphere and beautiful architecture. Devotees
          from all around visit to seek blessings and participate in the
          temple’s rituals.
        </Text>

        {/* Icon to toggle reading the description */}
        <TouchableOpacity
          style={styles.readAloudIcon}
          onPress={toggleReadDescription}
        >
          <Ionicons
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          navigation.navigate("Temple4", {
            temple,
            firstImage: templeImages[0].image,
          })
